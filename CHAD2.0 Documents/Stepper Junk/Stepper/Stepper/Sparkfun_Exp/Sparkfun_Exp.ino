...
#define stp 2   //pin that controls the steps, when moving from low->high it moves one step in desired direction, must be reset to low again before moving another step
#define dir 3
#define MS1 4
#define MS2 5
#define EN  6
